...
import sys
class peakTableWidget(QTableWidget):
    def __init__(self,*args):
        super(peakTableWidget, self).__init__(*args)
        self.setMore()
        self.setEvent()
    ...
    def addPeakInfo(self,peakLabel: str,peakPos: float,rePeakArea: float):
        self.setRowCount(self.rowCount()+1)
        item_peakLabel = QTableWidgetItem(peakLabel)
